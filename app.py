...
SCALE_QUESTIONS = [
    {"q": "Посветеност (Commitment)", "desc": "Колку силнo верува и работи кон долгорочната визија на Findzzer, без разлика на моменталните пречки."},
    {"q": "Автономија", "desc": "Колку може да работи самостојно, да носи одлуки и да испорачува без некој постојано да го контролира (micromanage)."},
    {"q": "Иновативност", "desc": "Колку често креира нови, креативни или 'out of the box' идеи кои го подобруваат продуктот или процесите."},
    {"q": "Доверливост", "desc": "Дали стои на зборот? Кога ќе каже дека нешто ќе биде завршено до одреден рок, колку можеш да се потпреш на тоа."},
    {"q": "Тежина на задачи", "desc": "Колку се технички, логички или ментално комплексни задачите што оваа личност ги решава секој ден."},
    {"q": "Комуникација и транспарентност", "desc": "Дали ги комуницира проблемите на време? Дали идеите и критиките ги кажува јасно, директно и отворено."},
    {"q": "Незаменливост", "desc": "Ако оваа личност утре си замине, колку би било тешко, болно и скапо за Findzzer да најде замена на пазарот."},
    {"q": "Потенцијал за скалирање", "desc": "Дали има капацитет и mindset утре да биде C-level лидер (директор) и ефикасно да раководи со оддел од 10+ луѓе."},
    {"q": "Прифаќање критика (Coachability)", "desc": "Колку добро оваа личност прифаќа конструктивна критика без да го става сопственото его на прво место?"},
    {"q": "Конзистентност во работата", "desc": "Дали темпото на работа е исто секој ден, или има огромни осцилации (една недела 24/7, следните две недели го нема)?"}
]
...
if not st.session_state['read_explanation']:
    ...
    *Сите гласови се строго анонимни. Системот не дозволува идентификација кој за кого како гласал, и алгоритмот за бодови скришно ги пресметува тежините на прашањата.*
    ...
    agree = st.checkbox("Разбирам како функционира формата и ветувам дека ќе гласам максимално искрено и фер за сите.")
    if agree:
        if st.button("Продолжи кон Евалуација ➔"):
...
with st.container():
    ...
    if evaluator != "-- Избери Име --":
        ...
        st.caption("Оцени го СЕКОЈ член (вклучително и себеси) од 1 до 10 за следниве прашања.")
